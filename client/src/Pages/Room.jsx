...
export default function Room(){
    ...
    return(
        ...
        <div className="absolute left-[50px] w-[200px]  rounded-3xl p-[0.5rem] text-center h-[40px] font-bold bg-green-600 text-black text-xl hover:bg-green-400 cursor-pointer">Add Room</div>
